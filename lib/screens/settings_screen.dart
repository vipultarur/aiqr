import 'package:aiqr_app/elements/build_section_container.dart';
...
import 'package:aiqr_app/controllers/history_controller.dart';
            ...
            Column(
              children: [
                ...
                buildNavigationRow(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse("https://tarurinfotech.base44.app/privacy/aiqr"),
                    );
                  },
                ),
                buildDivider(context),
                buildNavigationRow(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse("https://tarurinfotech.base44.app/contact/product?app=aiqr"),
                    );
                  },
                ),
              ],
